...
def build_country_code_converter(codeinfo):
    ...
    """
    csv_dict = read_csv_as_nested_dict(codeinfo['codefile'],
                                 codeinfo['plot_codes'], 
                                 codeinfo['separator'], 
                                 codeinfo['quote'])
    out_dict = {}
    for plot_code, data in csv_dict.items():
        out_dict[plot_code] = data[codeinfo['data_codes']] 
    return out_dict
...
def reconcile_countries_by_code(codeinfo, plot_countries, gdp_countries):
    ...
    """
    plot_dict1 = build_country_code_converter(codeinfo)
    plot_dict = {}
    plot_set = set()   
    out_set = set()
    for key,value in plot_countries.items():
        for keycode, valcode in plot_dict1.items():
    ...
    out_set = set(plot_set)            
    return plot_dict, out_set
...
def build_map_dict_by_code(gdpinfo, codeinfo, plot_countries, year):
    ...
    plot_dict, plot_set1 = reconcile_countries_by_code(codeinfo,plot_countries, new_data_dict)
        ...
        for key1,val1 in new_data_dict.items():
            if value.lower() == key1.lower():
                if val1[year]!='':
                    ...
                    plot_set_2.add(key)
    out_set1, out_set2 = set(plot_set1), set(plot_set_2)
    return plot_dict_1, out_set1, out_set2
